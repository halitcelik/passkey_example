...
BASE_DIR = "/home/projects/passkeys_example/passkeys_example"
CODE_DIR = BASE_DIR + "/passkeys_example"

env.hosts = ["passkeys_example@passkeys_example.cruncher.ch"]
env.activate = f"source {BASE_DIR}/.venv/bin/activate"
env.remote_db = "passkeys_example"
env.local_db = "passkeys_example"
env.git_branch = "main"
env.gunicorn_process = ["passkeys_example_gunicorn", ]
env.forward_agent = True
env.sentry_project_slug = "passkeys_example"
